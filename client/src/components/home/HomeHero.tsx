...
export function HomeHero() {
  return (
    <section className="relative min-h-screen bg-white overflow-hidden" aria-label="Hero Section">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 lg:pt-32 pb-16">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h1 
              variants={fadeInUp}
              className="text-5xl sm:text-6xl lg:text-7xl font-light text-charcoal leading-[0.9] mb-8 tracking-tight"
            >
              Advanced
            ...
            <motion.p 
              variants={fadeInUp}
              className="text-lg text-steel leading-relaxed mb-12 max-w-xl font-light"
            >
            ...
            <motion.div 
              variants={fadeInUp}
              className="grid grid-cols-2 lg:grid-cols-4 gap-8 pt-8 border-t border-steel/10"
            >
              {heroStats.map((stat, index) => (
                <div key={stat.label} className="text-left">
                  <div className="text-3xl lg:text-4xl font-light text-teal mb-2">
                    {stat.value}
                  </div>
                  <div className="text-xs text-steel uppercase tracking-wider font-medium">
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          >
            <div className="relative">
              {/* Decorative frame */}
              <div className="absolute -top-4 -left-4 w-full h-full border-2 border-teal/20 z-0" />
              <div className="absolute -bottom-4 -right-4 w-full h-full border border-forest/20 z-0" />
              ...
              <div className="absolute -top-8 -right-8 bg-cream border border-teal/20 p-4 z-20">
                <div className="text-xs text-steel uppercase tracking-wider mb-1">Mission Ready</div>
                <div className="text-lg font-semibold text-charcoal">100%</div>
              </div>
              
              <div className="absolute -bottom-8 -left-8 bg-white border border-forest/20 p-4 z-20">
                <div className="text-xs text-steel uppercase tracking-wider mb-1">Systems Deployed</div>
                <div className="text-lg font-semibold text-charcoal">250+</div>
              </div>
            </div>
          </motion.div>
        </div>
