...
export function HomeAssurance() {
  return (
    <section className="py-20 lg:py-32 bg-white" aria-labelledby="assurance-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Assurance Grid */}
        <motion.div
          className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-steel/5 mb-20"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: '-100px' }}
          variants={staggerChildren}
          ...
          {assuranceHighlights.map((highlight, index) => {
            ...
            return (
              <motion.div
                key={highlight.title}
                variants={fadeInUp}
                className="bg-white p-10 group hover:bg-cream/30 transition-all duration-500 relative overflow-hidden"
              >
                {/* Background Pattern */}
                ...
                <div className="mb-8 relative z-10">
                  <div className="w-16 h-16 border border-teal/20 flex items-center justify-center group-hover:border-teal/40 transition-colors">
                ...
                <div className="relative z-10">
                  <h3 className="text-lg font-semibold text-charcoal mb-4 leading-tight">
                    {highlight.title}
                  </h3>
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: '-100px' }}
          variants={staggerChildren}
          className="bg-charcoal text-cream p-12 relative overflow-hidden"
        >
          {/* Background Grid */}
          ...
          <div className="relative z-10">
            <motion.div variants={fadeInUp} className="text-center mb-12">
              <h3 className="text-2xl font-light text-cream mb-4">
            ...
            >
              {certificationStandards.map((standard, index) => (
                ...
                >
                  <div className="border border-steel/30 hover:border-teal/50 p-4 transition-all duration-300 bg-white/5 hover:bg-white/10">
                    <div className="text-sm font-semibold text-cream group-hover:text-teal transition-colors">
                      {standard}
                    </div>
                  </div>
                </motion.div>
            ...
            <motion.div 
              variants={fadeInUp}
              className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 pt-12 border-t border-steel/20"
            >
              ...
              <div className="text-center">
                <div className="text-3xl font-light text-teal mb-2">Zero</div>
                <div className="text-xs uppercase tracking-wider text-steel">
                  Mission Failures
                </div>
              </div>
